...
const MediaRow = ({ title, libraryId, onCardClick, onContextMenu, selectionMode, selectedItems }) => {
                ...
                >
                    {items.map(item => (
                        <MediaCard
                            key={item.Id}
                            item={item}
                            onClick={(item, e) => onCardClick ? onCardClick(item, e) : navigate(`/item/${item.Id}`)}
                            onContextMenu={(e, item) => onContextMenu(e, item, items)}
