...
async function injectFeaturedPrefs() {
    ...
    if (localBanner) {
        ...
        const pBannerUrl = `/Users/${user.Id}/Images/Banner?tag=${user.ImageTags.Banner}&maxHeight=500`;
...
window.uploadUserBackdrop = async function (imageUrl) {
    try {
        ...
        // 3. Upload
        const uploadUrl = window.ApiClient.getUrl(`/Users/${userId}/Images/Banner`);
